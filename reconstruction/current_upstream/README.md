...
|---|---|---|
| Current seed/root score and displacement summaries | `06_CODE_RELEASE/current_submission_replay/replay.py` | Current Figures 2–3 and Extended Data Figure 1 summaries, including CPA2560. Starts after allocation scoring. |
