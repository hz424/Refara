...
Data Figure 9 from the bundled scores and per-seed/root summaries. From the
repository root, use the installed Python 3.10 environment:
...
| Figure 3 | Per-seed/root displacement and score summaries | 576 plotted root values, 24 primary-depth comparisons and 96 comparisons over all depths, checked against current Source Data |
| Extended Data Figure 9 | 5,760 metric-score rows after allocation and seed averaging | Eight-model ranks, leader sets and Kendall concordance for 640 root-level and 80 aggregate designs, checked against the supplied concordance table |
...
Model comparisons and Figure 3 use the numerical implementations from the
[recorded base revision](https://github.com/hz424/reference-cell-benchmark-design/tree/af59f2cccba607fe2c9823d082e35cb537d8bac5).
