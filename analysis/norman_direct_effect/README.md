...
This directory retains the original 200-epoch CPA analysis. For the current Extended Data Figure 8 and Supplementary Table 1, use [the selected-CPA replay](../norman_training_review/README.md). The training and scoring commands below reproduce the earlier model and results.
